                    ...
                    <Row>
                        <Col xs="12" sm="12" md="8" lg="6">
                            <div className="hero-txt">
                                <h1>Immer auf dem <br /> <strong>Neusten Stand</strong></h1>
                                <p>Folgen Sie unserem Blog, um stets über die  neuesten Trends,<br /> Technologien und Projekte  informiert zu bleiben. <br /> Erhalten Sie exklusive Einblicke.</p>
